...
st.set_page_config(
    page_title="Mestre dos Greens PRO - V69.4 (League Fix)",
    page_icon=icon_page,
    layout="wide",
...
def load_data():
    ...
    # --- AQUI ESTAVA O ERRO: Nomes agora normalizados para bater com o Histórico ---
    URLS_ATUAIS = {
...
# APP PRINCIPAL
# ==============================================================================
st.title("🧙‍♂️ Mestre dos Greens PRO - V69.4 (League Fix)")
